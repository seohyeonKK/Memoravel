...
const Nickname = () => {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={Images.LoginBackground} resizeMode="cover"
                       style={[styles.backgroundImg, {alignItems: 'center'}]}>
        <View>
          <Animated.View style={[nicknameStyles.info, {opacity: fadeTxtAnim}, {transform: [{translateY: upAnim}]}]}>
            <Text
              style={[styles.gmarketMedium, nicknameStyles.infoText, {fontWeight: "700"}]}>
